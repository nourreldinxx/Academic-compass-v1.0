...
public class gpacert extends JFrame implements ActionListener, MouseListener {
    ...
    private void initcomponents() {
        ...
        jLabel2.setBounds(380, 13, 600, 76);
        this.add(jPanel1);
        jPanel1.add(jLabel1);
        jPanel1.add(jLabel2);
        ...
        if ("F".equals(grade.getText())) {
            ...
            GPA.setText("your gpa : "+String.format("%.2f", gpa));
            jPanel2.add(GPA);
            GPA.setBounds(20, 225, 350, 25);
            ...
            stamp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/F.png"))); // NOI18N
                    jPanel2.add(stamp);
            ...
            cert.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GPAcert.png"))); // NOI18N
            ...
            switch (grade.getText()) {
                case "A" -> {
                    stamp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/A.png"))); // NOI18N
                    cert.add(stamp);
                ...
                case "B+" -> {
                    stamp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/B+.png"))); // NOI18N
                    cert.add(stamp);
                    stamp.setBounds(620, 160, 200, 200);
                }
                case "B" -> {
                ...
                case "C+" -> {
                    stamp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/C+.png"))); // NOI18N          
                    cert.add(stamp);
                    stamp.setBounds(620, 160, 200, 200);
                }
                case "C" -> {
                ...
                case "D+" -> {
                    stamp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/D+.png"))); // NOI18N
                    cert.add(stamp);
                    stamp.setBounds(620, 160, 200, 200);
                }
                case "D" -> {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getSource() == menu2) {
            GPA_calc l=new GPA_calc(name,id);
            l.setVisible(true);
            this.setVisible(false);       
        }
